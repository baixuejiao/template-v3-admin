...
<script lang="ts">
  import { computed, defineComponent, onMounted, ref, shallowReactive, toRef } from 'vue'
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      onMounted(() => {
        selectItem.value = { font_class: '', name: defaultIcon.value || '选择图标' }
      })
      return {
        icons,
        selectItem,
