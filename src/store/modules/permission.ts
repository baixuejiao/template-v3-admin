...
// import { baseAddress } from '@/api/url/url'
import {  getMenuListByRoleId } from '@/api/url/login'
...
const usePermissionStore = defineStore('permission-route', {
  ...
  actions: {
    ...
    async initPermissionRoute() {
      ...
      // })
      const accessRoutes = await this.getRoutes(userStore.roleId)
